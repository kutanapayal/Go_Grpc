...
func (c *greetServiceClient) LongGreeting(ctx context.Context, opts ...grpc.CallOption) (GreetService_LongGreetingClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[1], "/greet.GreetService/LongGreeting", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *greetServiceLongGreetingClient) Send(m *GreetRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceLongGreetingClient) CloseAndRecv() (*GreetResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(GreetResponse)
...
func (x *greetServiceLongGreetingServer) SendAndClose(m *GreetResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceLongGreetingServer) Recv() (*GreetRequest, error) {
	m := new(GreetRequest)
